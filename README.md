...
- 尚未建立外部永久資料來源、自動測試及完整參數來源紀錄。


## 下一階段：V2多情境工作流程

下一階段先在鯉魚潭系統改造多情境推估流程，已確認的完整規格請見：

- [V2多情境推估工作流程規格](docs/V2_MULTI_SCENARIO_SPEC.md)

第一階段將完成1～N個入流情境、共用0旬至全部推估旬、共用出流、批次演算、步驟四單一情境詳情，以及步驟五跨批次比較相容。此階段不串接Google Sheet、不做帳號或管理密碼，也不修改核心水量平衡公式。

第一階段驗收後，第二階段才建立Google Sheet共用正式推估、重開網站自動載入、管理密碼、歷次版本及還原功能。
